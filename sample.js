class CarFactory {
    ...
    resultArea() {
        const resultCarFactory = `This car from ${this.car} has been sold ${this.totalCar
...
class Honda extends Car {
    ...
    resultArea() {
        const theCar = `A car with ${this.tyre} tyres, ${this.seat} seats, ${this.door} doors, ${this.body
...
class Toyota extends Car {
    ...
    resultArea() {
        const theCar = `A car with ${this.tyre}, ${this.seat}, ${this.door}, ${this.body
            }, and ${this.engine}`;
        return theCar;
    }
}
